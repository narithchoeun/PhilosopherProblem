...
An implementation that does not use multiple locks in meaningful ways will receive at most 45 points.

Experiment by executing your program on a 2-core (or more) machine with 10 philosophers, 25 philosophers, 50 philosophers & 100 philosophers.
Compare their execution times, waiting times, number of times each thread stalls & other meaningful metrics (e.g. minimum number of turns someone has eaten).
